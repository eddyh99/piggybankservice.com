...
class Transactions extends CI_Controller
{
    ...
    public function historytopup()
    {
        ...
        $result = apitrackless(URLAPI . "/v1/admin/wallet/gethistory_topup", json_encode($mdata));
    ...
    public function historywallet()
    {
        ...
        $result = apitrackless(URLAPI . "/v1/admin/wallet/gethistory_wallet", json_encode($mdata));
        $data["token"] = $this->security->get_csrf_hash();
        $data["history"] = $result->message;
        echo json_encode($data);
    }
    ...
    public function historybank()
    {
        ...
        $result = apitrackless(URLAPI . "/v1/admin/wallet/gethistory_tobank", json_encode($mdata));
        $data["token"] = $this->security->get_csrf_hash();
        $data["history"] = $result->message;
        echo json_encode($data);
    }
