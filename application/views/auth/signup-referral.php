    ...
    <div class="container">
        <div class="row d-flex d-lg-inline-grid justify-content-center align-items-center">
            <div class="col-10 col-sm-9 col-md-7 col-lg-5 box-form">
                <form class="form-login-freedy d-flex align-items-start flex-column" style="height: 100%;" method="POST" action="<?= base_url(); ?>auth/register_referral">
                    ...
                    <div class="col-12 d-grid gap-2 mt-5">
                        <p class="text-center f-roboto"><b>ATTENTION</b> : it is necessary to have a REFERRAL CODE for
                            the
                            subscription on the platform, if you do not have it follow us on our <a href="https://instagram.com/piggybankservice?igshid=YmMyMTA2M2Y=">Instagram</a> page and
                            request it.
                        </p>
                    </div>
                </form>
