        ...
        <div class="row">
            ...
            <div class="col-10 my-5 text-start mx-auto">
                ...
                <p>At <span translate="no"> PiggyBank </span>, accessible from PiggyBankService.com, one of our main
                    ...
                    by PiggyBankService.com and how we use it.
                    If you have additional questions or require more information about our Privacy Policy, do not
                    hesitate to contact us.</p>
                <h5 class="fw-bold mt-3 mb-0">Log Files</h5>
                <p>PiggyBankService.com follows a standard procedure of using log files. These files log visitors when
                    they
                ...
                <h5 class="fw-bold mt-3 mb-0">Cookies and Web Beacons</h5>
                <p>Like any other website, PiggyBankService.com uses 'cookies'. These cookies are used to store
                    information
                ...
                <p>You may consult this list to find the Privacy Policy for each of the advertising partners of
                    ...
                    Note that PiggyBankService.com has no access to or control over these cookies that are used by
                    third-party
                    advertisers.</p>
                <h5 class="fw-bold mt-3 mb-0">Third Party Privacy Policies</h5>
                <p>PiggyBankService.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                    advising
                ...
                <h5 class="fw-bold mt-3 mb-0">Children's Information</h5>
                <p>Another part of our priority is adding protection for children while using the internet. We encourage
                    ...
                    activity.<br>
                    PiggyBankService.com does not knowingly collect any Personal Identifiable Information from children
                    under
                ...
                <h5 class="fw-bold mt-3 mb-0">Online Privacy Policy Only</h5>
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in PiggyBankService.com. This policy
                    is not
                    applicable to any information collected offline or via channels other than this website.</p>
                <h5 class="fw-bold mt-3 mb-0">Consent</h5>
