...
<section id="" class="hero d-flex align-items-center p-3 pt-md-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 my-5">
                <div class="logo-text text-center">
                    <img src="<?= base_url() ?>assets/img/u-img-5.png" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <p>
                            ...
                            Send an email to <u class="text-dark">contact@piggybankservice.vip</u> with the<br>
                            subject FIND ME<br>
            ...
            <div class="col-12 mb-5 mt-3">
                <div class="col-12 text-center mb-5">
                    ...
                    <p class="mt-3">
                        In order to topup your <b translate="no"> PiggyBank </b> crypto wallet follow the procedure
                        below In order to top up
                        your MoneyPort crypto wallet follow the procedure below (make sure to have balances into your
                        FIAT wallet, in case you don’t have top it up first in your favorite FIAT currencies): :
                    </p>
