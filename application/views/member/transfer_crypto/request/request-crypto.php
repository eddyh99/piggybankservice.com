                ...
                <div class="app-container py-5" style="margin-top: 5rem;">
                    ...
                    <div class="row">
                        <div class="col-12 text-white">
                            <h4 class="text-center">Request USDX</h4>
                    ...
                    <div class="row d-flex justify-content-center mt-5">
                        <div class="col-12 col-md-7 col-lg-7 settings-currency d-flex">
                            <a href="<?= base_url() ?>transfer_crypto/requestorder_crypto" class="btn-toggle-crypto-currency d-flex justify-content-center align-items-center">
