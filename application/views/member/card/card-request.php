                            ...
                            <form action="<?=base_url()?>card/activecard" method="POST">
                                ...
                                <div class="row my-5 mx-auto d-flex justify-content-center">
                                    <div class="col-md-10 my-2">
                                        <input class="nohp-select inputPass" type="password" name="passwd" placeholder="*Create a password 3D Secure" minlength="8" maxlength="35" required>
                                    </div>
                                    <div class="col-md-10 my-2 mt-4">
                                        <input class="nohp-select inputPass" type="password" name="confpasswd" placeholder="*Confirm 3D Secure password"  minlength="8" maxlength="35" required>
                                    </div>
                                </div>
                                <div class="text-start d-flex justify-content-center mt-5 mb-4">
                                    <button type="submit"
